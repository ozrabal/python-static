...
class ParentNode(HTMLNode):
  def __init__(self, tag, children, props=None):
      """
      Initialize a ParentNode, which is an HTMLNode that must have a tag and can have children.
      
      Args:
          tag: Required HTML tag name (e.g., "div", "ul", "section").
          children: Required list of HTMLNode children.
          props: Attributes dictionary (e.g., {"class": "container"}). Optional.
      """
  ...
  def to_html(self):
      ...
      Raises:
          ValueError: If the parent node has no tag or no children list.
      """
      if self.tag is None:
